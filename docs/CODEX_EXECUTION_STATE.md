...
active_v4_prebeta_work:
  ...
  functional_status: "the self-relative Issue #60 candidate commit containing this ledger implements the bounded Codex text vertical slice, independent local/record-only/OpenAI STT, Keychain BYOK and routing UI, exact persisted Meeting Chat enforcement, catalog-revalidated remote configuration, bounded workspace-metadata handling, recording-to-canonical handoff, app-owned recording lifecycle, New Meeting coordinator, transcript outline/search, truthful About composition, normal-user usability corrections, fixed content-free Apple Unified Logging, and a fail-closed sanitized diagnostics copy; 545 tests are discovered, the 520-test non-GUI warnings-as-errors shard plus isolated scale and three-hour tests pass locally, and a fresh one-pass warnings-as-errors Release build passes, while exact PR native-window/visual CI, remote review, sustained real-device matrices, complete outbound-network proof, and explicit residual product decisions remain open"
  visual_baseline:
    prior_candidate: "GitHub Actions run 30408544276, evidence job 90439382718, exact source 82b1abc1b921b37c730e54c699574272c54e8f0e"
    prior_manifest_sha256: "9e132dc5fdff0fdd9fcc14823f3c82db9fbcfbcc619faa1749853c94c1a0c4c6"
    refresh_status: "required_pending_exact_review_remediation_commit_candidate_calibration_import_and_regression"
    review: "the prior 50-image review remains historical evidence only; final normal-user layout corrections require all 50 Light/Dark images to be regenerated and reviewed before merge"
    ...
    prior_calibration: "GitHub Actions run 30409045361, evidence job 90440892621, exact source 82b1abc1b921b37c730e54c699574272c54e8f0e"
    determinism: "final candidate determinism remains pending; the prior calibration cannot prove the corrected layout"
  source_release_plan:
    version: "v0.4.0"
...
blocked_tasks: []
last_known_git_head: "the self-relative Issue #60 0.4.0 candidate commit containing this ledger is based directly on protected main 77a4deca11190587c557e081667fb6c0e64a0f4a, which includes the reviewed and rebase-merged PR #61 foundation"
working_tree_status_summary: "the self-relative Issue #60 foundation carrier is merged in PR #61; branch codex/60-v4-codex-transport carries the later self-relative 0.4.0 build-4 formal-test candidate: Codex text intelligence, independent local/remote/record-only STT, BYOK/Keychain and Task Routing, meeting/window lifecycle recovery, transcript outline/search, lightweight New Meeting and About composition, content-free diagnostics, focused UI integration, audit reconciliation, and tests. U1, production billing, website connection/deployment, bundled runtime, schema migration for UN/official-record ingestion, complete export expansion, Sparkle, Developer ID/notarization, and public binary distribution remain outside this candidate"
last_verification_commands:
  - "final 0.4.0 review-remediation local gate at 2026-07-29T12:36:07-04:00: stable Package.resolved; warning-as-errors Debug build; fresh scratch-path warning-as-errors Release build; 520-test remaining shard; isolated 10,000-position scale and three-hour retry tests; four public-brand tests; plist and shell syntax. Local AppKit activation was unavailable, so native-window and visual results are explicitly deferred to the exact PR runner"
  - "current Issue #60 0.4.0 build-4 formal-test candidate at 2026-07-28T23:19:05Z: exact repository-CI-shaped warnings-as-errors test shards for the remaining suite, 12 isolated native windows, visual contracts, 10,000-position scale, and three-hour retry; fresh one-command Release swift build -c release -Xswiftc -warnings-as-errors in a new scratch root; swift package resolve with Package.resolved drift rejection; deterministic brand regeneration; plist and shell syntax; git diff --check; Markdown/YAML/link and bounded sensitive-pattern checks"
...
last_verification_results:
  - "0.4.0 review-remediation local refresh at 2026-07-29T12:36:07-04:00 discovers 545 tests; the warnings-as-errors remaining shard passes 520 tests in 65 suites, the isolated 10,000-position historical test passes, and the isolated three-hour retry simulation passes in 4.958 seconds. A fresh independent Release build completes in 105.08 seconds with a 33,814,048-byte executable at SHA-256 50925acfc6bb0a2ef3121d2e40b9725cc259c7e37a2d39a36513f0c0a02817ad; Package.resolved remains a14ed642cc66bd9ebdfcbfc4f23886a78afa0663d97e5243848bf77fbb688e26. The local Codex desktop process could not activate AppKit test windows despite Accessibility trust, so typed applicationActivationFailed/accessibilityWindowUnavailable results are not claimed as product failures or passes; exact PR native-window and visual runner evidence remains required"
  - "0.4.0 functional visual calibration at 2026-07-29T00:00:46Z: exact-runner calibration run 30409045361 job 90440892621 succeeded from source 82b1abc1b921b37c730e54c699574272c54e8f0e. Three fresh processes each captured five continuously hosted frames for all 50 cases; all 750 frames and 1,500 within-process pair comparisons were exact, all per-case hashes matched the reviewed candidate, and the three durable calibration records preserve the pre-import manifest and fixture-catalog bindings"
  - "0.4.0 functional visual candidate review at 2026-07-28T23:47:15Z: exact-runner candidate run 30408544276 job 90439382718 produced 50 unique contract-bound PNGs from source 82b1abc1b921b37c730e54c699574272c54e8f0e; all declared PNG hashes match, 26 images are byte-identical, and the 24 reviewed Light/Dark changes are limited to the authorized Local Media, Recording, New Meeting/shell, and Transcript controls. The imported manifest retains exact 0/0/1 thresholds, the canonical and audit copies match, and the local 11-test BlueMinutesVisualRegressionTests contract shard passes with only the pinned exact-runner harness skipped as designed"
  - "v4 formal-test candidate local gate at 2026-07-28T23:19:05Z: the accepted exact repository-CI-shaped warnings-as-errors run covers 538 discovered tests through a 513-test/65-suite remaining shard, 12 passing isolated native-window tests, the 11-test visual-contract shard with only its pinned exact-runner harness skipped locally, a passing isolated 10,000-position historical test with 9.44-second rebuild and 0.36-second first page, and a passing 5.77-second three-hour retry simulation; six installed Apple/Codex probes remain explicit opt-in skips in the remaining shard. A fresh isolated one-pass Release build completes in 115.75 seconds with a 33,861,392-byte executable at SHA-256 b8bf403dc77aa573b1f75e3474788f38233f9f11e678a63ff49202c99be24e37. Package.resolved remains at SHA-256 a14ed642cc66bd9ebdfcbfc4f23886a78afa0663d97e5243848bf77fbb688e26; plist, shell syntax, deterministic brand regeneration, whitespace, YAML duplicate-key, 118 local Markdown-link, and bounded sensitive-pattern checks pass. The pinned native visual harness remains a PR CI gate because this local machine intentionally does not impersonate its exact runner"
  ...
  - "v4 foundation current-tree local gate at 2026-07-28T15:43:12Z: a new isolated scratch root passes package dump, warning-as-error Debug build in 31.91 seconds, and warning-as-error Release build in 79.97 seconds; the initial 12 ProviderRoutingContractTests and 4 PublicBrandPresentationTests pass, the 10,000-position historical scale shard passes with 9.77-second rebuild and 0.34-second first page, the 444-test/58-suite remaining shard passes, 12 isolated native-window tests pass, the 11-test visual-contract shard passes with its exact-runner harness explicitly skipped, and the isolated three-hour retry simulation passes. These CI-shaped shards cover the initial 469 discovered tests with three installed Apple-model checks plus the exact-runner visual harness explicitly environment-gated; a monolithic invocation that returned zero without a Swift Testing aggregate was rejected as evidence"
  - "PR #61 review remediation at 2026-07-28T16:12:35Z: owner-bound global/workspace/meeting-revision routing profiles reject cross-workspace, cross-meeting-revision, and wrong-scope cache entries; 13 ProviderRoutingContractTests pass with warnings as errors"
  - "PR #61 second review remediation at 2026-07-28T16:23:55Z: configured update feeds require both exact feed and service-endpoint allowlists, and UpdateSafetyGate accepts only a validated composite ReleaseIntegrationConfiguration so a standalone UpdatePolicy cannot authorize check, download, or install; 13 ProviderRoutingContractTests pass with warnings as errors"
