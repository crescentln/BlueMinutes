...
Status: Future Slice I first baseline accepted for pull-request validation;
actual-application and protected-main gates remain open
...
The accepted candidate was generated by GitHub Actions run `30306957209`,
evidence job `90113453412`, from source revision
...
The accepted calibration was generated by GitHub Actions run `30307533539`,
evidence job `90115266147`, at that same source revision and exact environment.
...
matched the corresponding accepted-candidate PNG hash, and all measured
differences were zero. The three immutable records are checked in as
...
The accepted manifest's `baselineSourceRevision` remains the exact capture
source above and intentionally precedes the later resource-import carrier
commit. The calibration records' `manifestSHA256`
(`07e9a4afb34812996ad9bedc31aa3352a634d8d230fb9498e93d555503c548c6`)
records the pre-import committed 46-case manifest that existed at the capture
source. Acceptance is instead bound to the matching source revision, exact
environment, fixture-catalog hash
(`89e36083055d242d85ebacc5812a0e435898d92f07d7937a565babc054605153`),
and the verified one-to-one candidate PNG hashes. This historical field is
preserved rather than rewritten after the fact.
